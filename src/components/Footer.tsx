...
const Footer: React.FC = () => {
  ...
  <a href="./assets/facebook.svg" target="_blank" rel="noopener noreferrer">
    <img
      src={facebookImage}
      alt="Facebook Logo"
      style={{ width: '20px', height: '50px', marginRight: '10px'}}
  ...
  <a href="./assets/2b6e796d-2275-41a6-8b90-5d2b3f89f680.png" target="_blank" rel="noopener noreferrer">
    <img
      src={sonyPicture}
      alt="Sony Picture"
